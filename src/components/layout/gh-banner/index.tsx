  ...
  return (
    ...
    >
      ...
      >
        ...
        >
         <img
            src="/Screenshot 2024-12-06 190649.png" // Update the path to your actual logo image
            alt="OffTrack Storage Logo"
            style={{
              width: "32px", // Adjust width as needed
              height: "32px", // Adjust height as needed
              marginRight: "8px", // Add some spacing between the logo and the text
            }}
          />
        </span>
        <span className="text">
